...
public class MenuView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(244, 238, 224, 255));

        titleJLabel.setFont(new java.awt.Font("Snap ITC", 1, 50)); // NOI18N
        titleJLabel.setForeground(new java.awt.Color(79, 69, 87));
        titleJLabel.setText("OTHELLO");

        jLabel2.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_computer_40px_1.png")); // NOI18N

        playervsplayerJButton.setBackground(new java.awt.Color(109, 93, 110));
        playervsplayerJButton.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        playervsplayerJButton.setForeground(new java.awt.Color(57, 54, 70));
        ...
        playervspcJButton.setBackground(new java.awt.Color(109, 93, 110));
        playervspcJButton.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        playervspcJButton.setForeground(new java.awt.Color(57, 54, 70));
        ...
        optionsJButton.setBackground(new java.awt.Color(109, 93, 110));
        optionsJButton.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        optionsJButton.setForeground(new java.awt.Color(57, 54, 70));
        ...
        guideJButton.setBackground(new java.awt.Color(109, 93, 110));
        guideJButton.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        guideJButton.setForeground(new java.awt.Color(57, 54, 70));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_person_40px.png")); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_person_40px.png")); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_person_40px.png")); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_services_40px_2.png")); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_support_40px_9.png")); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_question_mark_40px.png")); // NOI18N

        jLabel9.setIcon(new javax.swing.ImageIcon(Parameter.image + "\\icons8_question_mark_40px.png")); // NOI18N
